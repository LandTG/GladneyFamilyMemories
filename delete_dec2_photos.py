...
# Get all photos created on December 2, 2025
cursor.execute("SELECT id, filename, file_path FROM photos WHERE date(created_at) = '2025-12-02'")
photos = cursor.fetchall()

print(f"Found {len(photos)} photos to delete from December 2, 2025")
...
for photo_id, filename, file_path in photos:
    ...
    try:
        ...
        # Then delete from vignette_photos (if any)
...
print(f"\n{'='*50}")
print(f"Successfully deleted {deleted_count} photos from December 2, 2025")
print(f"{'='*50}")
